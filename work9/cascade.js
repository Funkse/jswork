var collegeSelectFun= ['电子与通信学院', '先进制造学院', '电气技术学院', '汽车学院', '计算机与设计学院', '外语商务学院', '经济贸易学院', '物流学院', '马克思主义学院']
var majorSelectFun = [
    ['电子', '电信', '通信', '嵌入', '物联'],
    ['数控', '模具', '机设', '机自'],
...
createOption(collegeSelect,collegeSelectFun);
var majorSelect = document.getElementById('majorSelect');
collegeSelect.onchange = function(){
    majorSelect.options.length = 0;
    createOption(majorSelect,majorSelectFun[collegeSelect.value]);
...
majorSelect.onchange = function(){
    classSelect.options.length=0;
    createOption(classSelect,classSelectFun[collegeSelect.value][majorSelect.value]);
}